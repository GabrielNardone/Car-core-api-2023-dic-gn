...
import { PICTURE_REPOSITORY } from './application/repository/picture.repository.interface';
...
@Module({
  imports: [TypeOrmModule.forFeature([PictureSchema]), CommonModule, CarModule],
